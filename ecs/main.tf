...
resource "aws_ecs_service" "flask_service" {
  name            = "flask-service"                             # Naming our first service
  ...
  network_configuration {
    #subnets          = ["subnet-060408f45163e994d", "subnet-0499a7d308a7e9525", "subnet-0a05cebd8184ebc51"]
...
resource "aws_alb" "application_load_balancer" {
  name               = "${var.name}-lb" # Naming our load balancer
